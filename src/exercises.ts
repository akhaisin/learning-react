...
export const exercises: Exercise[] = [
  ...
  { id: 'stopWatch',            label: 'Stop Watch',          solution: true, tags: [Tag.State, Tag.Effects, Tag.Refs, Tag.Hooks] },
  ...
  { id: 'todoList',             label: 'Todo List',           solution: true,  tags: [Tag.State, Tag.Forms],
    variations: [
      ...
      { id: 'useReducer', label: 'useReducer', solution: true },
    ],
  },
  ...
  { id: 'accordion',            label: 'Accordion',           solution: true, tags: [Tag.State, Tag.TypeScript] },

  // Intermediate hooks
  { id: 'formWithValidation',   label: 'Form With Validation', solution: true, tags: [Tag.State, Tag.Forms, Tag.TypeScript] },
  { id: 'multiStepForm',        label: 'Multi-Step Form',     solution: true, tags: [Tag.State, Tag.Reducer, Tag.Forms] },
  { id: 'useLocalStorage',      label: 'useLocalStorage',     solution: true, tags: [Tag.Hooks, Tag.Effects, Tag.TypeScript] },

  // Context & state machines
  { id: 'themeContext',         label: 'Theme Context',       solution: true, tags: [Tag.Context, Tag.Hooks] },
  { id: 'toastNotifications',  label: 'Toast Notifications', solution: true, tags: [Tag.Context, Tag.Reducer, Tag.Hooks] },
  ...
  { id: 'dragAndDrop',          label: 'Drag And Drop',       solution: true, tags: [Tag.State, Tag.DOM, Tag.DragDrop] },
  { id: 'autocomplete',         label: 'Autocomplete',        solution: true, tags: [Tag.State, Tag.Hooks, Tag.Async, Tag.Forms] },

  // Async
  { id: 'useFetch',             label: 'useFetch',            solution: true, tags: [Tag.Hooks, Tag.Effects, Tag.Async] },
  { id: 'infiniteScroll',       label: 'Infinite Scroll',     solution: true, tags: [Tag.Refs, Tag.Effects, Tag.Async, Tag.DOM] },

  // Advanced
  { id: 'useUndo',              label: 'useUndo',             solution: true, tags: [Tag.Hooks, Tag.State, Tag.TypeScript] },
  { id: 'virtualList',          label: 'Virtual List',        solution: true, tags: [Tag.Refs, Tag.DOM, Tag.Performance] },
];
